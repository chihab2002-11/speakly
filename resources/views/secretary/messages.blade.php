<x-layouts.secretary :title="__('Messages')" :current-route="'role.messages.index'">
        ...
        <div class="flex w-full flex-col border-r md:w-80 lg:w-96 {{ $selectedUser ? 'hidden md:flex' : 'flex' }}" style="border-color: var(--lumina-border);">
            <div class="flex items-center justify-between border-b p-4" style="border-color: var(--lumina-border);">
                ...
                <button
                    ...
                    class="flex h-8 w-8 items-center justify-center rounded-lg transition-all hover:bg-gray-100"
                ...
                <div class="border-t p-4" style="border-color: var(--lumina-border);">
                    <form action="{{ route('role.messages.store', ['role' => $currentRole]) }}" method="POST">
                        ...
                        <div class="flex items-end gap-3">
                            ...
                            <button
                                type="submit"
                                class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl transition-all hover:opacity-90"
    ...
    >
        ...
        >
            ...
            <div class="space-y-3 border-b p-4" style="border-color: var(--lumina-border);">
                <div>
                    ...
                    <select
                        ...
                        class="w-full cursor-pointer rounded-xl border px-4 py-2 text-sm outline-none transition-all focus:ring-2"
                        style="border-color: var(--lumina-border); background-color: var(--lumina-bg-card);"
                    >
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function loadRecipients() {
                try {
                    const response = await fetch('{{ route("secretary.messages.recipients") }}');
