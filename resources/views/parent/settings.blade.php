...
>
        ...
        <div class="flex flex-col gap-6">
            ...
            >
                ...
                <button 
                    ...
                    class="mt-4 flex items-center justify-center gap-2 rounded-xl border border-dashed p-4 text-sm font-semibold transition-colors hover:bg-gray-50 cursor-pointer"
                    style="border-color: var(--lumina-border); color: var(--lumina-text-muted);"
                >
    ...
    >
        <div 
            class="w-full max-w-md rounded-3xl border p-8 shadow-2xl mx-4"
            style="background-color: #FFFFFF; border-color: rgba(190, 201, 191, 0.1); border-radius: 24px;"
        >
            {{-- Modal Header --}}
            <div class="mb-6 flex items-center justify-between">
                ...
                <button 
                    ...
                    class="flex h-8 w-8 items-center justify-center rounded-full transition-colors hover:bg-gray-100 cursor-pointer"
                >
                    <svg class="h-5 w-5" fill="currentColor" style="color: var(--lumina-text-muted);" viewBox="0 0 24 24">
            ...
            <form class="flex flex-col gap-5" method="POST" action="#">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input 
                        type="text" 
                        name="student_id"
                        placeholder="Enter student ID (e.g., STU-2024-0001)"
                        class="w-full rounded-xl border px-4 py-3 text-sm outline-none transition-all focus:ring-2"
                        style="background-color: var(--lumina-bg-card); border-color: var(--lumina-border); color: var(--lumina-text-primary); --tw-ring-color: var(--lumina-primary);"
                        required
                    >
                    <p class="text-xs" style="color: var(--lumina-text-muted);">
                        You can find this on your child's student card
                    </p>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-medium" style="color: var(--lumina-text-secondary);">
                        Child's Full Name <span style="color: #EF4444;">*</span>
                    </label>
                    <input 
                        type="text" 
                        name="child_name"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input 
                        type="date" 
                        name="date_of_birth"
                        class="w-full rounded-xl border px-4 py-3 text-sm outline-none transition-all focus:ring-2 cursor-pointer"
                        style="background-color: var(--lumina-bg-card); border-color: var(--lumina-border); color: var(--lumina-text-primary); --tw-ring-color: var(--lumina-primary);"
                        required
                    >
                    <p class="text-xs" style="color: var(--lumina-text-muted);">
                        Used to verify the student's identity
                    </p>
                </div>
    ...
    <script>
        ...
        document.getElementById('linkChildModal').addEventListener('click', function(e) {
            if (e.target === this) {
                closeLinkChildModal();
            }
        });
