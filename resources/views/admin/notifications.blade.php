<x-layouts.admin :title="__('Notifications')">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-base" style="color: var(--lumina-text-secondary);">
                Stay updated with messages and system activities.
            </p>
        </div>
    ...
    <div 
        ...
        data-live-notification-read-route-template="{{ route('admin.notifications.read', ['id' => '__ID__']) }}"
    >
            ...
            >
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3 flex items-center gap-4">
                        ...
                        {{-- Mark as Read Button --}}
                        @if(!$notification->read_at)
                            <form method="POST" action="{{ route('admin.notifications.read', $notification->id) }}" class="ml-auto">
                                @csrf
                                <button 
                                    type="submit"
                                    class="text-xs font-semibold transition-colors hover:underline"
