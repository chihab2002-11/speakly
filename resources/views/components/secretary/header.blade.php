        ...
        <div class="flex items-center gap-2 md:gap-4">
            ...
            >
                ...
                @if($unreadNotificationsCount > 0)
                    <span class="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold text-white" style="background-color: var(--lumina-accent-red);">
