        ...
        <div class="flex flex-col gap-6">
            ...
            >
                ...
                <div class="mb-4 flex items-baseline gap-4">
                    <div>
                        <span class="text-sm font-medium" style="color: var(--lumina-text-secondary);">Level</span>
                        <h4 class="text-5xl font-black" style="color: var(--lumina-primary);">
                            {{ $proficiencyLevel ?? 'C1' }}
                        </h4>
                    </div>
                    <span class="text-lg font-semibold" style="color: var(--lumina-text-secondary);">
                        {{ $proficiencyStatus ?? 'Advanced' }}
                    </span>
                </div>

                {{-- Progress Bar --}}
                <div class="mb-2 h-2 w-full overflow-hidden rounded-full" style="background-color: var(--lumina-border);">
                    <div 
                        class="h-full rounded-full transition-all"
                        style="width: {{ $proficiencyPercent ?? 84 }}%; background-color: var(--lumina-primary);"
                    ></div>
                </div>

                {{-- Progress Text --}}
                <div class="mb-6 flex items-center justify-between">
                    <span class="text-sm" style="color: var(--lumina-text-secondary);">Progress to C2</span>
                    <span class="text-sm font-bold" style="color: var(--lumina-primary);">{{ $proficiencyPercent ?? 84 }}%</span>
                </div>
                ...
                >
                    <div 
                        ...
                        style="background-color: var(--lumina-accent-green);"
                    >
                        <svg class="h-4 w-4" fill="currentColor" style="color: var(--lumina-primary-dark);" viewBox="0 0 24 24">
                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
                        </svg>
                    </div>
                    <div>
                        <span class="text-xs font-bold uppercase tracking-wider" style="color: var(--lumina-text-muted);">
                            Upcoming Milestone
                        </span>
                        <p class="text-sm font-medium" style="color: var(--lumina-text-primary);">
                            {{ $upcomingMilestone ?? 'C1 Final Certification exam scheduled for next Tuesday.' }}
                        </p>
                    </div>
                </div>
            </div>
