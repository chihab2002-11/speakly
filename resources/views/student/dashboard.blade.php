        ...
        >
            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:gap-8">
                ...
                <div class="flex flex-col items-center gap-2 lg:ml-auto">
                    <div 
                        class="flex h-24 w-24 items-center justify-center rounded-xl lg:h-28 lg:w-28"
                        style="background-color: white; border: 2px solid var(--lumina-border);"
                    >
                        {{-- QR Code placeholder - in production, generate with a QR library --}}
                        <svg class="h-20 w-20 lg:h-24 lg:w-24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                            {{-- QR Code pattern (simplified representation) --}}
                            <rect x="10" y="10" width="25" height="25" fill="var(--lumina-text-primary)"/>
                            <rect x="15" y="15" width="15" height="15" fill="white"/>
                            <rect x="20" y="20" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="65" y="10" width="25" height="25" fill="var(--lumina-text-primary)"/>
                            <rect x="70" y="15" width="15" height="15" fill="white"/>
                            <rect x="75" y="20" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="10" y="65" width="25" height="25" fill="var(--lumina-text-primary)"/>
                            <rect x="15" y="70" width="15" height="15" fill="white"/>
                            <rect x="20" y="75" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            {{-- Data pattern --}}
                            <rect x="40" y="10" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="50" y="10" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="40" y="20" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="45" y="25" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="55" y="20" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="10" y="40" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="20" y="45" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="25" y="40" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="10" y="50" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="40" y="40" width="20" height="20" fill="var(--lumina-text-primary)"/>
                            <rect x="45" y="45" width="10" height="10" fill="white"/>
                            <rect x="48" y="48" width="4" height="4" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="65" y="40" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="75" y="45" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="80" y="40" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="85" y="50" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="40" y="65" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="50" y="70" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="55" y="65" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="45" y="75" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="55" y="80" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            
                            <rect x="65" y="65" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="75" y="70" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="70" y="75" width="5" height="5" fill="var(--lumina-text-primary)"/>
                            <rect x="80" y="80" width="10" height="10" fill="var(--lumina-text-primary)"/>
                            <rect x="85" y="70" width="5" height="5" fill="var(--lumina-text-primary)"/>
                        </svg>
                    </div>
                    <span class="text-[10px] font-bold uppercase tracking-wider" style="color: var(--lumina-text-muted);">
                        Scan for ID
            ...
            {{-- Bottom Stats Row --}}
            <div class="mt-6 grid gap-4 border-t pt-6 sm:grid-cols-2" style="border-color: var(--lumina-border);">
                {{-- Enrolled Courses --}}
                <div class="flex flex-col gap-2">
                    ...
                    {{-- Progress Bar --}}
                    <div class="h-1.5 w-full overflow-hidden rounded-full" style="background-color: var(--lumina-border);">
                        <div class="h-full rounded-full" style="width: {{ $courseProgressPercent ?? 75 }}%; background-color: var(--lumina-primary);"></div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    {{-- Progress Bar --}}
                    <div class="h-1.5 w-full overflow-hidden rounded-full" style="background-color: var(--lumina-border);">
                        <div class="h-full rounded-full" style="width: {{ $lessonProgressPercent ?? 60 }}%; background-color: var(--lumina-primary);"></div>
                    </div>
                </div>
            </div>
        </div>
